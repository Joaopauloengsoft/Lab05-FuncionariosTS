...
function cadastrarFuncionarios(empresa) {
    ...
    const f1 = new Funcionario(1001, "Ana Silva", "Desenvolvedora", 8500.00);
    const f2 = new Funcionario(1002, "Carlos Souza", "Designer", 7200.00);
    const f3 = new Funcionario(1003, "Beatriz Lima", "Analista de RH", 6800.00);
